...
export async function fetchMatchById(
  ...
  return await tracedPromise("fetchMatchById", async () => {
...
export async function findMatchesForGameAndUser(
  ...
  return await tracedPromise("findMatchesForGameAndUser", async () => {
...
export async function createMatch(
  ...
  return await tracedPromise("createMatch", async () => {
...
export async function takeMatchUserTurn(
  db: GamePlayDB,
  user: SelectUser,
  match_id: MatchId,
  action: NewAction
): Promise<null | NotFound | NotAllowed | GameError> {
  return await tracedPromise("takeMatchUserTurn", async () => {
